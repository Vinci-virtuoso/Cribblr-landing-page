    ...
    <section id="services" className="py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 items-start">
            ...
            >
              <CarouselContent className="-ml-1">
                {services.map((service) => (
                  <CarouselItem key={service.id} className="pl-1 md:basis-1/2 lg:basis-1/3 w-full">
                    <div className="p-1">
                      <Card className={cn("border-0 rounded-2xl overflow-hidden", service.bgClass)}>
          ...
          <div className="lg:pl-12 mt-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">Transform Your Business with AI</h2>
            <p className="text-base sm:text-lg text-gray-300 mb-8">
              Our comprehensive suite of AI services is designed to help businesses of all sizes harness the power of artificial intelligence. From autonomous agents to enterprise consulting and chatbot development, we provide end-to-end solutions that drive efficiency and innovation.
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl bg-white/5">
                <h3 className="text-xl font-bold mb-2">Customized Solutions</h3>
                <p className="text-gray-300">Tailored AI implementations that match your specific business needs and objectives.</p>
              </div>
              <div className="p-6 rounded-2xl bg-white/5">
                <h3 className="text-xl font-bold mb-2">Scalable Architecture</h3>
                <p className="text-gray-300">Built to grow with your business, ensuring long-term sustainability and success.</p>
              </div>
            </div>
          </div>
        </div>
